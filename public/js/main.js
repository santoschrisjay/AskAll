(function ($) {
	...
	$(document).ready(function () {
		$(".table-row").click(function () {
			...
			const dateCreated = $(this).find("td:nth-child(6)").text();
...
function convertWeight() {
	...
	document.getElementById("weightResult").innerHTML =
		inputWeight + " " + fromUnit + " is " + result + " " + toUnit;
}
...
function convertFromLongTon(weight, toUnit) {
	switch (toUnit) {
		...
		case "gram":
			return weight * 1.01605e6;
		case "milligram":
			return weight * 1.01605e9;
		case "metricTon":
...
function convertVolume() {
	...
	document.getElementById("volumeResult").innerHTML =
		inputVolume + " " + fromUnit + " is " + result + " " + toUnit;
}
...
function convertTime() {
	...
	document.getElementById("timeResult").innerHTML =
		inputTime + " " + fromUnit + " is " + result + " " + toUnit;
}
...
function convertFromMicrosecond(time, toUnit) {
	switch (toUnit) {
		...
		case "minute":
			return time / (60 * 1e6);
		case "hour":
			return time / (3600 * 1e6);
		case "day":
			return time / (3600 * 24 * 1e6);
		case "week":
			return time / (3600 * 24 * 7 * 1e6);
		case "month":
			return time / (3600 * 24 * 30.44 * 1e6);
		case "year":
			return time / (3600 * 24 * 365.25 * 1e6);
		default:
			return "Invalid to unit";
	}
}
...
function convertFromNanosecond(time, toUnit) {
	switch (toUnit) {
		...
		case "minute":
			return time / (60 * 1e9);
		case "hour":
			return time / (3600 * 1e9);
		case "day":
			return time / (3600 * 24 * 1e9);
		case "week":
			return time / (3600 * 24 * 7 * 1e9);
		case "month":
			return time / (3600 * 24 * 30.44 * 1e9);
		case "year":
			return time / (3600 * 24 * 365.25 * 1e9);
		default:
			return "Invalid to unit";
	}
}
...
function convertFromPicosecond(time, toUnit) {
	switch (toUnit) {
		...
		case "minute":
			return time / (60 * 1e12);
		case "hour":
			return time / (3600 * 1e12);
		case "day":
			return time / (3600 * 24 * 1e12);
		case "week":
			return time / (3600 * 24 * 7 * 1e12);
		case "month":
			return time / (3600 * 24 * 30.44 * 1e12);
		case "year":
			return time / (3600 * 24 * 365.25 * 1e12);
		default:
			return "Invalid to unit";
	}
}
...
function convertFromDay(time, toUnit) {
	switch (toUnit) {
		...
		case "microsecond":
			return time * 24 * 3600 * 1e6;
		case "nanosecond":
			return time * 24 * 3600 * 1e9;
		case "picosecond":
			return time * 24 * 3600 * 1e12;
		case "minute":
			return time * 24 * 60;
		case "hour":
			return time * 24;
...
function convertFromWeek(time, toUnit) {
	switch (toUnit) {
		...
		case "microsecond":
			return time * 7 * 24 * 3600 * 1e6;
		case "nanosecond":
			return time * 7 * 24 * 3600 * 1e9;
		case "picosecond":
			return time * 7 * 24 * 3600 * 1e12;
		case "minute":
			return time * 7 * 24 * 60;
		case "hour":
			return time * 7 * 24;
...
function convertFromMonth(time, toUnit) {
	switch (toUnit) {
		...
		case "microsecond":
			// Assuming an average month length of 30.44 days
			return time * 30.44 * 24 * 3600 * 1e6;
		case "nanosecond":
			// Assuming an average month length of 30.44 days
			return time * 30.44 * 24 * 3600 * 1e9;
		case "picosecond":
			// Assuming an average month length of 30.44 days
			return time * 30.44 * 24 * 3600 * 1e12;
		case "minute":
			// Assuming an average month length of 30.44 days
...
function convertFromYear(time, toUnit) {
	switch (toUnit) {
		...
		case "microsecond":
			// Assuming an average year length of 365.25 days
			return time * 365.25 * 24 * 3600 * 1e6;
		case "nanosecond":
			// Assuming an average year length of 365.25 days
			return time * 365.25 * 24 * 3600 * 1e9;
		case "picosecond":
			// Assuming an average year length of 365.25 days
			return time * 365.25 * 24 * 3600 * 1e12;
		case "minute":
			// Assuming an average year length of 365.25 days
...
function convertTemperature() {
	...
	document.getElementById("temperatureResult").innerHTML =
		inputTemperature + " " + fromUnit + " is " + result + " " + toUnit;
}
...
function convertLength() {
	...
	document.getElementById("lengthResult").innerHTML =
		inputLength + " " + fromUnit + " is " + result + " " + toUnit;
}
...
function convertArea() {
	...
	document.getElementById("areaResult").innerHTML =
		inputArea + " " + fromUnit + " is " + result + " " + toUnit;
}
